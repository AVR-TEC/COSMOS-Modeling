...
mkdir build
cd build
cmake -DCMAKE_INSTALL_PREFIX=/usr -DUSE_CUDA=ON -DCUDA_ARCH=62 -DUSE_OPENCV_CONTRIB=ON -DUSE_DARKNET=ON -DDarknet_root=/home/ubuntu/dev/darknet -DUSE_REALSENSE=ON -Dlibrealsense_root=/home/ubuntu/dev/librealsense -DUSE_ORB_SLAM2=OFF -DORB_SLAM2_root=/home/ubuntu/dev/orb_slam2_gpu -DUSE_TENSORRT=OFF -DTensorRT_build=/home/ubuntu/dev/jetson-inference-batch/build/aarch64 ../
make all -j4
